...
def train(env, batch_size=5, num_epochs=4, lr=0.0003, num_games=300, learn_every=20, print_every=20, max_score=10000):
    ...
    agent = PPOAgent(num_actions=action_spec.shape[0], 
    ...
    for i in range(num_games):
        ...
        while not time_step.last():
            ...
            video.append(np.hstack([env.physics.render(size, size, camera_id=0),
...
if __name__ == '__main__':
    ...
    # run train loop
    trained_agent, score_hist, avg_score_hist, video = train(env, print_every=1, num_games=1)
